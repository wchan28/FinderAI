...
- `app/` - Next.js 14 App Router pages and layouts
  - `app/alerts/` - Fantasy alerts and notifications
  - `app/history/` - Historical data and transaction history
  - `app/league/` - League overview and standings
  - `app/performance/` - Player and team performance analytics
  - `app/roster/` - Roster management pages
  - `app/settings/` - Application settings
  - `app/trades/` - Trade analysis and management
